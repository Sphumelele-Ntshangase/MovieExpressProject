<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tables.aspx.cs" Inherits="MEWeb.Tables.tables" %>
            ...
            var AssessmentsTab = HomeContainer.Helpers.TabControl();
            {
              ...
              var HomeContainerTab = AssessmentsTab.AddTab("Basic Examples");
              {
                var Row = HomeContainerTab.Helpers.DivC("row margin0");
                {
                  ...
                  {
                    RowCol.Helpers.HTML().Heading2("Example of a Data Table");
                    RowCol.Helpers.HTMLTag("p").HTML = "This is a basic example of a Singular BootstrapTable.";
                    ...
                    var UserList = RowCol.Helpers.BootstrapTableFor<MELib.Movies.Movie>((c) => c.MovieList, false, false, "");
                    {
                      ...
                      {
                        //var MoviePosterCol = UserListFirstRow.AddColumn("");
                        //{
                        //  var ImageDiv = MoviePosterCol.Helpers.DivC("ImageDiv");
                        //  {
                        //    ImageDiv.Helpers.Image().AddBinding(Singular.Web.KnockoutBindingString.src, c => c.ImageURL);
                        //  }
                        //}
                        ...
                        //var FirstNameCol = UserListFirstRow.AddColumn("Movie Category");
                        //{
                        //  var FirstNameColText = FirstNameCol.Helpers.Span(c => c.CategoryName);
                        //}
                        var Actions = UserListFirstRow.AddColumn("Actions");
                        {
                          // Add Buttons
                          var btnView = Actions.Helpers.Button("View", Singular.Web.ButtonMainStyle.NoStyle, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.search);
                          {
                          ...
                          var btnDelete = Actions.Helpers.Button("Delete", Singular.Web.ButtonMainStyle.NoStyle, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.trash);
                          {

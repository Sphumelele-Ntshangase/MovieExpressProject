              ...
              var TabHeading = PageTab.AddTab("Basic Page");
              {
                var MainRow = TabHeading.Helpers.DivC("row margin0");
                {
                  var MainCol = MainRow.Helpers.DivC("col-md-12");
                  {
                    ...
                    MainCol.Helpers.HTML("<p>The Grid system is a powerful mobile-first flexbox grid to build layouts of all shapes and sizes thanks to a twelve column system. Please read more about the grid system by following the link below.</p>");
                    {
                      var ReadMoreBtn = MainCol.Helpers.Button("Read More on Bootstrap...", Singular.Web.ButtonMainStyle.NoStyle, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.file);
                      {
                        ReadMoreBtn.AddBinding(Singular.Web.KnockoutBindingString.click, "ReadMore()");
                        ReadMoreBtn.AddClass("btn btn-primary btn-outline");
                      }
                      // Another Button
                      var AnotherReadMoreBtn = MainCol.Helpers.Button("Read More on Knockout...", Singular.Web.ButtonMainStyle.NoStyle, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.file);
                      {
                        AnotherReadMoreBtn.AddBinding(Singular.Web.KnockoutBindingString.click, "ReadMoreKnockoutJS()");
                        AnotherReadMoreBtn.AddClass("btn btn-primary btn-outline");
                      }
                    }
                ...
                var FirstRow = TabHeading.Helpers.DivC("row margin0");
                {
                  ...
                  {
                    RowCol.Helpers.HTML().Heading3("Column 1");
                  ...
                  {
                    SecondRowCol.Helpers.HTML().Heading3("Column 2");
                    SecondRowCol.Helpers.HTML("<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>");
                  }
                }
                ...
                var Row = TabHeading.Helpers.DivC("row margin0");
                {
                  ...
                  {
                    ThirdRowCol.Helpers.HTML().Heading3("Column 3");
                ...
                var AnotherRow = TabHeading.Helpers.DivC("row margin0");
                {
                  ...
                  {
                    FourthRowCol.Helpers.HTML().Heading3("Column 4");

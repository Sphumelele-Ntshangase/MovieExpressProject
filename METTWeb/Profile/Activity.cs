...
namespace MEWeb.Movies
{
  ...
  : SingularBusinessBase<Activity>
  {
    #region " Properties and Methods "

    #region " Properties "

    public static PropertyInfo<int> ActivityIDProperty = RegisterProperty<int>(c => c.ActivityID, "ID", 0);
    /// <summary>
    /// Gets the ID value
    /// </summary>
    ...
    public static PropertyInfo<string> ActivityTypeProperty = RegisterProperty<string>(c => c.ActivityType, "Activity Type", "");
    /// <summary>
    /// Gets and sets the Activity Type value
    /// </summary>
    [Display(Name = "Activity Type", Description = ""),
    StringLength(250, ErrorMessage = "Activity Type cannot be more than 250 characters")]
    public string ActivityType
    {
      get { return GetProperty(ActivityTypeProperty); }
      set { SetProperty(ActivityTypeProperty, value); }
    }
    ...
    {
      return GetProperty(ActivityIDProperty);
    }
    ...
    public override string ToString()
    {
      if (this.ActivityType.Length == 0)
      {
        if (this.IsNew)
        {
          return String.Format("New {0}", "Activity");
        }
        else
        {
          return String.Format("Blank {0}", "Activity");
        }
      }
      else
      {
    ...
    protected override void OnCreate()
    {
      ...
      // Set any variables here, not in the constructor or NewActivity() method.
    }

    public static Activity NewActivity()
    {
      return DataPortal.CreateChild<Activity>();
    }
    ...
    internal static Activity GetActivity(SafeDataReader dr)
    {
      var a = new Activity();
      a.Fetch(dr);
      return a;
    ...
    protected void Fetch(SafeDataReader sdr)
    {
      ...
      {
        int i = 0;
        LoadProperty(ActivityIDProperty, sdr.GetInt32(i++));
        LoadProperty(ActivityTypeProperty, sdr.GetString(i++));
    ...
    protected override Action<SqlCommand> SetupSaveCommand(SqlCommand cm)
    {
      ...
      AddPrimaryKeyParam(cm, ActivityIDProperty);

      cm.Parameters.AddWithValue("@ActivityType", GetProperty(ActivityTypeProperty));
      ...
      return (scm) =>
      {
        ...
        if (this.IsNew)
        {
          LoadProperty(ActivityIDProperty, scm.Parameters["@ActivityID"].Value);
        }
      };
    }
    ...
    {
      cm.Parameters.AddWithValue("@ActivityID", GetProperty(ActivityIDProperty));
    }

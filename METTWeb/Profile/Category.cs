...
namespace MEWeb.Movies
{
  ...
  : SingularBusinessBase<Category>
  {
    ...
    public static PropertyInfo<string?> CategoryNameProperty = RegisterProperty<string?>(c => c.CategoryName, "Category Name", (string?)"");
    /// <summary>
    ...
    protected void Fetch(SafeDataReader sdr)
    {
      using (BypassPropertyChecks)
      {
        ...
        LoadProperty(CategoryNameProperty, sdr.GetValue(i++));
    ...
    protected override Action<SqlCommand> SetupSaveCommand(SqlCommand cm)
    {
      ...
      cm.Parameters.AddWithValue("@CategoryName", Singular.Misc.NothingDBNull(GetProperty(CategoryNameProperty)));

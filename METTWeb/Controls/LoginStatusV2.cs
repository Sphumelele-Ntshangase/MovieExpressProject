  ...
  public class LoginStatusV2 : HelperControls.HelperBase<object>
  {
    ...
    protected override void Setup()
    {
      ...
      if (Singular.Security.Security.HasAuthenticatedUser)
      {
        ...
        {
          aTagUserName.Helpers.HTML("<i class='fas fa-user fa-2x fa-fw pull-left'></i>"); //added for image icon
        ...
        ulTagDropDown.AddClass("dropdown-menu animated fadeInRight");
        {
          var liTagEditProfile = ulTagDropDown.Helpers.HTMLTag("li");
          {
            ...
            aTagEditProfile.Attributes["href"] = VirtualPathUtility.ToAbsolute("~/Profile/Profile.aspx?UserID=" + HttpUtility.UrlEncode(Singular.Encryption.EncryptString(identity.UserID.ToString()))); //added this line to enable rofile editing
            {

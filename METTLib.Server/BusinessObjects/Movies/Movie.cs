...
namespace MELib.Movies
{
   ...
   : MEBusinessBase<Movie>
  {
    ...
    //Singular.DataAnnotations.DropDownWeb(typeof(MELib.Movies.Movie), ValueMember = "MovieID", DisplayMember = "MovieTitle")] //added for movie title filtering
    ...
    public static PropertyInfo<Decimal> PriceProperty = RegisterProperty<decimal>(c => c.Price, "Price", Convert.ToDecimal(0));//modified
    /// <summary>
